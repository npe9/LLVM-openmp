...
// Lithe scheduler callback implementations (prefixed with kmp_ to avoid conflicts)
static void kmp_hart_request(lithe_sched_t *__this, lithe_sched_t *child, int h);
static void kmp_hart_enter(lithe_sched_t *__this);
static void kmp_hart_return(lithe_sched_t *__this, lithe_sched_t *child);
static void kmp_sched_enter(lithe_sched_t *__this);
static void kmp_sched_exit(lithe_sched_t *__this);
static void kmp_child_enter(lithe_sched_t *__this, lithe_sched_t *child);
static void kmp_child_exit(lithe_sched_t *__this, lithe_sched_t *child);
static void kmp_context_block(lithe_sched_t *__this, lithe_context_t *context);
static void kmp_context_unblock(lithe_sched_t *__this, lithe_context_t *context);
static void kmp_context_yield(lithe_sched_t *__this, lithe_context_t *context);
static void kmp_context_exit(lithe_sched_t *__this, lithe_context_t *context);
...
int __kmp_lithe_create_worker(kmp_lithe_scheduler_t *scheduler, int gtid) {
    ...
    // Initialize the context - use lithe_context_stack_t struct members
